...
public func randomBegriffixStrategy(hits: BegriffixHits, game: Begriffix) -> Begriffix.Move? {
...
public func shortBegriffixStrategy(hits: BegriffixHits, game: Begriffix) -> Begriffix.Move? {
...
public func longBegriffixStrategy(hits: BegriffixHits, game: Begriffix) -> Begriffix.Move? {
...
public func availabilityBegriffixStrategy(hits: BegriffixHits, game: Begriffix) -> Begriffix.Move? {
  guard let (place, words) = hits.min(by: {
...
public func minPlacesBegriffixStrategy(hits: BegriffixHits, game: Begriffix) -> Begriffix.Move? {
  do {
